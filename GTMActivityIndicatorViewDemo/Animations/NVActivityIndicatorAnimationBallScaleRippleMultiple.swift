...
class NVActivityIndicatorAnimationBallScaleRippleMultiple: NVActivityIndicatorAnimation {
    ...
    func setUpAnimation(in layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Draw circles
        for i in 0 ..< 3 {
            let circle = NVActivityIndicatorShape.ring(lineWidth: 2, margin: 0).layerWith(size: size, color: color)
