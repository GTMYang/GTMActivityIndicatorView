...
class NVActivityIndicatorAnimationBallSpinFadeLoader: NVActivityIndicatorAnimation {
    ...
    func circleAt(angle: CGFloat, size: CGFloat, origin: CGPoint, containerSize: CGSize, color: UIColor) -> CALayer {
        ...
        let circle = NVActivityIndicatorShape.circle(margin: 0).layerWith(size: CGSize(width: size, height: size), color: color)
        let frame = CGRect(
